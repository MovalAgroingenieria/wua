...
class WuaRepresentation(models.Model):
    ...
    def _default_representation_main_text(self):
        representation_main_text = _(
            ...
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbs'
            'p;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
            'The Communard<br><br><br><br><br>VAT {{ agent.vat_wua_legalrep }}'
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
            '&nbsp;&nbsp;&nbsp;VAT {{ partner.vat }}<br><br><b>THE COMMUNITY '
            'SECRETARY</b><br><br><br><br>VAT {{ assembly.secretary_id.vat }}'
            '<br></div></div>')
    ...
    def name_get(self):
        result = []
        if self.env.context.get('show_only_partner', False):
            for record in self:
                result.append((record.id, record.partner_id.name))
        else:
            for record in self:
                assembly_date_str = \
                    self.env['wua.parcel'].transform_date_to_locale(
                        record.assembly_id.assembly_date)
                name = assembly_date_str + ' (' + record.partner_id.name + ')'
