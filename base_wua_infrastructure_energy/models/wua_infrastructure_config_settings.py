...
class WuaInfrastructureConfiguration(models.TransientModel):
    ...
    def set_default_values(self):
        ...
        values.set_default('wua.infrastructure.configuration',
                           ...
                           self.url_gis_viewer_powerline_param)
        values.set_default('wua.infrastructure.configuration',
                           'url_gis_viewer_powerlinesupport_param',
                           self.url_gis_viewer_powerlinesupport_param)
        values.set_default('wua.infrastructure.configuration',
                           'url_gis_viewer_processingcentre_param',
                           self.url_gis_viewer_processingcentre_param)
