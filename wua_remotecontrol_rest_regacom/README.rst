...
===========================================================
Water Users Association Irrigation (interface with Regacom)
===========================================================

Interface of Moval Regadio with the Regacom SQL database
based on a REST API
...
Regacom is a SQL database system for remote control and monitoring
