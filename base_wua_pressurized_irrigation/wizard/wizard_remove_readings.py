...
class WizardRemoveReadings(models.TransientModel):
    ...
    def _get_default_initial_date(self):
        current_reading = self.env['wua.reading'].browse(
    ...
    def _calculate_readings_to_delete(self):
        ...
        self.num_readings_to_delete = len(self.env['wua.reading'].search([
    ...
    def delete_readings(self, initial_date, end_date):
        ...
        readings_to_delete = self.env['wua.reading'].search([
        ...
        for reading_to_delete in readings_to_delete:
            watermeter_list.append(
                self.env['wua.watermeter'].browse(
                    reading_to_delete.watermeter_id.id))
