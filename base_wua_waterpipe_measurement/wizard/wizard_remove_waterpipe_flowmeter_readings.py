...
class WizardRemoveWaterpipeFlowmeterReadings(models.TransientModel):
    _name = 'wizard.remove.waterpipe.flowmeter.readings'
    _description = 'Dialog box to delete waterpipe flow-meter readings'
    ...
    def _get_default_initial_date(self):
        current_reading = self.env['wua.waterpipeflowreading'].browse(
    ...
    def _calculate_readings_to_delete(self):
        ...
        self.num_readings_to_delete = \
            len(self.env['wua.waterpipeflowreading'].search([
    ...
    def delete_readings(self, initial_date, end_date):
        ...
        readings_to_delete = self.env['wua.waterpipeflowreading'].search([
