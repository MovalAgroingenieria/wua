...
class WuaComparativeCultivationPresconsumptionGlobal(models.Model):
    _name = 'wua.comparative.cultivation.presconsumption.global'
    _description = 'Comparative Cultivation Presconsumption Global'
    _auto = False
    _order = 'cultivation_id'
    ...
    def init(self):
        tools.drop_view_if_exists(
            self.env.cr, 'wua_comparative_cultivation_presconsumption_global')
        self.env.cr.execute("""
            CREATE OR REPLACE VIEW
            wua_comparative_cultivation_presconsumption_global
            ...
            wcsp1.agriculturalseason_id, wcsp1.cultivation_id)
            """)
    ...
    def fields_view_get(self, view_id=None, view_type='form',
        ...
        res = super(WuaComparativeCultivationPresconsumptionGlobal, self).\
            fields_view_get(view_id=view_id, view_type=view_type,
                            toolbar=toolbar, submenu=submenu)
        if view_type == 'tree':
            control_periodicity = doc = etree.XML(res['arch'])
