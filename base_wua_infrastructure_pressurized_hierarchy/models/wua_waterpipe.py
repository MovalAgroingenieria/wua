...
class WuaWaterpipe(models.Model):
    ...
    @api.depends('parcel_wp_01_ids', 'parcel_wp_02_ids', 'parcel_wp_03_ids',
                 ...
                 'parcel_wp_40_ids',
                 'parcel_wp_01_ids.active', 'parcel_wp_02_ids.active',
                 'parcel_wp_03_ids.active', 'parcel_wp_04_ids.active',
                 'parcel_wp_05_ids.active', 'parcel_wp_06_ids.active',
                 'parcel_wp_07_ids.active', 'parcel_wp_08_ids.active',
                 'parcel_wp_09_ids.active', 'parcel_wp_10_ids.active',
                 'parcel_wp_11_ids.active', 'parcel_wp_12_ids.active',
                 'parcel_wp_13_ids.active', 'parcel_wp_14_ids.active',
                 'parcel_wp_15_ids.active', 'parcel_wp_16_ids.active',
                 'parcel_wp_17_ids.active', 'parcel_wp_18_ids.active',
                 'parcel_wp_19_ids.active', 'parcel_wp_20_ids.active',
                 'parcel_wp_21_ids.active', 'parcel_wp_22_ids.active',
                 'parcel_wp_23_ids.active', 'parcel_wp_24_ids.active',
                 'parcel_wp_25_ids.active', 'parcel_wp_26_ids.active',
                 'parcel_wp_27_ids.active', 'parcel_wp_28_ids.active',
                 'parcel_wp_29_ids.active', 'parcel_wp_30_ids.active',
                 'parcel_wp_31_ids.active', 'parcel_wp_32_ids.active',
                 'parcel_wp_33_ids.active', 'parcel_wp_34_ids.active',
                 'parcel_wp_35_ids.active', 'parcel_wp_36_ids.active',
                 'parcel_wp_37_ids.active', 'parcel_wp_38_ids.active',
                 'parcel_wp_39_ids.active', 'parcel_wp_40_ids.active')
    ...
    def init(self):
        ...
        try:
            parcel_model.create_wua_gis_waterpipe_table()
            parcel_model.create_waterpipe_triggers()
        except Exception:
            pass
