        ...
        nv.addGraph(function () {
            ...
            switch(self.graph_type) {
                ...
                case "bar-values":
                    ...
                    if ('ymax' in self.data[0].values[0]) {
                         var ymax = self.data[0].values[0].ymax
                         var ymin = 0
                         if ('ymin' in self.data[0].values[0]) {
                             ymin = self.data[0].values[0].ymin
                         }
                         self.chart.yDomain([ymin,ymax]);
                    }
                    if ('color' in self.data[0].values[0]) {
                        self.chart.color([self.data[0].values[0].color]);    
                    }
...
kanban_widgets.registry.add('wua_dashboard_graph', JournalDashboardGraph);
