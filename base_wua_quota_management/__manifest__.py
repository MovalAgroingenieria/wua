...

{
    ...
    "data": [
        ...
        "data/wua_quota_aggregated_value_refresh_cron.xml",
        ...
        "views/wua_quota_general_view.xml",
        "views/wua_hydricmovement_view.xml",
        "views/wua_superproduct_dashboard_view.xml",
        "views/wua_generalinput_view.xml",
        "views/wua_individualinput_view.xml",
        "views/wua_individualinput_massive_assignment_view.xml",
        "views/wua_massive_cancel_balances_view.xml",
        "views/wua_massive_compensatorytransfers_view.xml",
        "views/wua_massive_assignments_view.xml",
