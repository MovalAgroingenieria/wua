        ...
        for path in addons_path:
            if '/wua/custom/sdtoalbatera' in path \
                ...
                varless_file = path + '/sdtoalbatera/'\
                    'backend_theme_v10_mod_sdtoalbatera/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/sdtoalbatera/'\
                    'backend_theme_v10_mod_sdtoalbatera/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/sdtoalbatera' in path \
                ...
                varless_file = path + '/sdtoalbatera/'\
                    'backend_theme_v10_mod_sdtoalbatera/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/sdtoalbatera/'\
                    'backend_theme_v10_mod_sdtoalbatera/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/sdtoalbatera/'\
                    'backend_theme_v10_mod_sdtoalbatera/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/sdtoalbatera/'\
                    'backend_theme_v10_mod_sdtoalbatera/static/src/css/'\
                    'backend_mod_new.css'
