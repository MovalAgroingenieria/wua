        ...
        for path in addons_path:
            if '/wua/custom/crtorreabraham' in path \
                ...
                varless_file = path + '/crtorreabraham/'\
                    'backend_theme_v10_mod_crtorreabraham/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/crtorreabraham/'\
                    'backend_theme_v10_mod_crtorreabraham/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/crtorreabraham' in path \
                ...
                varless_file = path + '/crtorreabraham/'\
                    'backend_theme_v10_mod_crtorreabraham/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/crtorreabraham/'\
                    'backend_theme_v10_mod_crtorreabraham/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/crtorreabraham/'\
                    'backend_theme_v10_mod_crtorreabraham/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/crtorreabraham/'\
                    'backend_theme_v10_mod_crtorreabraham/static/src/css/'\
                    'backend_mod_new.css'
