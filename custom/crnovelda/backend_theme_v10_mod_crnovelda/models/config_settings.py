...
class CustomColorConfiguration(models.TransientModel):
    ...
    def init(self):
        ...
        for path in addons_path:
            if '/wua/custom/crnovelda' in path \
                    and self._module == 'backend_theme_v10_mod_crnovelda':
                path = os.path.dirname(path)
                varless_file = path + '/crnovelda/'\
                    'backend_theme_v10_mod_crnovelda/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/crnovelda/'\
                    'backend_theme_v10_mod_crnovelda/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/crnovelda' in path \
                ...
                varless_file = path + '/crnovelda/'\
                    'backend_theme_v10_mod_crnovelda/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/crnovelda/'\
                    'backend_theme_v10_mod_crnovelda/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/crnovelda/'\
                    'backend_theme_v10_mod_crnovelda/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/crnovelda/'\
                    'backend_theme_v10_mod_crnovelda/static/src/css/'\
                    'backend_mod_new.css'
