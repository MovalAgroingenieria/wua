...
class CustomColorConfiguration(models.TransientModel):
    ...
    def init(self):
        ...
        for path in addons_path:
            if '/wua/custom/crlibrilla' in path \
                    and self._module == 'backend_theme_v10_mod_crlibrilla':
                path = os.path.dirname(path)
                varless_file = path + '/crlibrilla/'\
                    'backend_theme_v10_mod_crlibrilla/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/crlibrilla/'\
                    'backend_theme_v10_mod_crlibrilla/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/crlibrilla' in path \
                ...
                varless_file = path + '/crlibrilla/'\
                    'backend_theme_v10_mod_crlibrilla/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/crlibrilla/'\
                    'backend_theme_v10_mod_crlibrilla/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/crlibrilla/'\
                    'backend_theme_v10_mod_crlibrilla/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/crlibrilla/'\
                    'backend_theme_v10_mod_crlibrilla/static/src/css/'\
                    'backend_mod_new.css'
