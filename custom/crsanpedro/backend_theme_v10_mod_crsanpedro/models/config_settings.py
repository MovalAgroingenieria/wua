...
class CustomColorConfiguration(models.TransientModel):
    ...
    def init(self):
        ...
        for path in addons_path:
            if '/wua/custom/crsanpedro' in path \
                    and self._module == 'backend_theme_v10_mod_crsanpedro':
                path = os.path.dirname(path)
                varless_file = path + '/crsanpedro/'\
                    'backend_theme_v10_mod_crsanpedro/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/crsanpedro/'\
                    'backend_theme_v10_mod_crsanpedro/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/crsanpedro' in path \
                ...
                varless_file = path + '/crsanpedro/'\
                    'backend_theme_v10_mod_crsanpedro/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/crsanpedro/'\
                    'backend_theme_v10_mod_crsanpedro/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/crsanpedro/'\
                    'backend_theme_v10_mod_crsanpedro/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/crsanpedro/'\
                    'backend_theme_v10_mod_crsanpedro/static/src/css/'\
                    'backend_mod_new.css'
