        ...
        for path in addons_path:
            if '/custom/crsantodomingo' in path \
                ...
                varless_file = path + '/crsantodomingo/'\
                    'backend_theme_v10_mod_crsantodomingo/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/crsantodomingo/'\
                    'backend_theme_v10_mod_crsantodomingo/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/custom/crsantodomingo' in path \
                ...
                varless_file = path + '/crsantodomingo/'\
                    'backend_theme_v10_mod_crsantodomingo/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/crsantodomingo/'\
                    'backend_theme_v10_mod_crsantodomingo/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/crsantodomingo/'\
                    'backend_theme_v10_mod_crsantodomingo/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/crsantodomingo/'\
                    'backend_theme_v10_mod_crsantodomingo/static/src/css/'\
                    'backend_mod_new.css'
