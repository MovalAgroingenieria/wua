        ...
        for path in addons_path:
            if '/wua/custom/satisidoro' in path \
                ...
                varless_file = path + '/satisidoro/'\
                    'backend_theme_v10_mod_satisidoro/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/satisidoro/'\
                    'backend_theme_v10_mod_satisidoro/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/satisidoro' in path \
                ...
                varless_file = path + '/satisidoro/'\
                    'backend_theme_v10_mod_satisidoro/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/satisidoro/'\
                    'backend_theme_v10_mod_satisidoro/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/satisidoro/'\
                    'backend_theme_v10_mod_satisidoro/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/satisidoro/'\
                    'backend_theme_v10_mod_satisidoro/static/src/css/'\
                    'backend_mod_new.css'
