        ...
        for path in addons_path:
            if '/wua/custom/sdtogranja' in path \
                ...
                varless_file = path + '/sdtogranja/'\
                    'backend_theme_v10_mod_sdtogranja/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/sdtogranja/'\
                    'backend_theme_v10_mod_sdtogranja/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/sdtogranja' in path \
                ...
                varless_file = path + '/sdtogranja/'\
                    'backend_theme_v10_mod_sdtogranja/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/sdtogranja/'\
                    'backend_theme_v10_mod_sdtogranja/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/sdtogranja/'\
                    'backend_theme_v10_mod_sdtogranja/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/sdtogranja/'\
                    'backend_theme_v10_mod_sdtogranja/static/src/css/'\
                    'backend_mod_new.css'
