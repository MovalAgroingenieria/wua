        ...
        for path in addons_path:
            if '/wua/custom/crtollos' in path \
                ...
                varless_file = path + '/crtollos/'\
                    'backend_theme_v10_mod_crtollos/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/crtollos/'\
                    'backend_theme_v10_mod_crtollos/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/crtollos' in path \
                ...
                varless_file = path + '/crtollos/'\
                    'backend_theme_v10_mod_crtollos/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/crtollos/'\
                    'backend_theme_v10_mod_crtollos/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/crtollos/'\
                    'backend_theme_v10_mod_crtollos/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/crtollos/'\
                    'backend_theme_v10_mod_crtollos/static/src/css/'\
                    'backend_mod_new.css'
