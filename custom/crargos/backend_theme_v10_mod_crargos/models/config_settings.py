...
class CustomColorConfiguration(models.TransientModel):
    ...
    def init(self):
        ...
        for path in addons_path:
            if '/wua/custom/crargos' in path \
                    and self._module == 'backend_theme_v10_mod_crargos':
                path = os.path.dirname(path)
                varless_file = path + '/crargos/'\
                    'backend_theme_v10_mod_crargos/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/crargos/'\
                    'backend_theme_v10_mod_crargos/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/crargos' in path \
                ...
                varless_file = path + '/crargos/'\
                    'backend_theme_v10_mod_crargos/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/crargos/'\
                    'backend_theme_v10_mod_crargos/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/crargos/'\
                    'backend_theme_v10_mod_crargos/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/crargos/'\
                    'backend_theme_v10_mod_crargos/static/src/css/'\
                    'backend_mod_new.css'
