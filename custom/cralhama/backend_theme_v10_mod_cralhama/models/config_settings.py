        ...
        for path in addons_path:
            if '/custom/cralhama' in path \
                ...
                varless_file = path + '/cralhama/'\
                    'backend_theme_v10_mod_cralhama/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/cralhama/'\
                    'backend_theme_v10_mod_cralhama/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/custom/cralhama' in path \
                ...
                varless_file = path + '/cralhama/'\
                    'backend_theme_v10_mod_cralhama/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/cralhama/'\
                    'backend_theme_v10_mod_cralhama/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/cralhama/'\
                    'backend_theme_v10_mod_cralhama/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/cralhama/'\
                    'backend_theme_v10_mod_cralhama/static/src/css/'\
                    'backend_mod_new.css'
