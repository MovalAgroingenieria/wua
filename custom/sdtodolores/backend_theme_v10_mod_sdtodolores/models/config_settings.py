        ...
        for path in addons_path:
            if '/custom/sdtodolores' in path \
                ...
                varless_file = path + '/sdtodolores/'\
                    'backend_theme_v10_mod_sdtodolores/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/sdtodolores/'\
                    'backend_theme_v10_mod_sdtodolores/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/custom/sdtodolores' in path \
                ...
                varless_file = path + '/sdtodolores/'\
                    'backend_theme_v10_mod_sdtodolores/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/sdtodolores/'\
                    'backend_theme_v10_mod_sdtodolores/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/sdtodolores/'\
                    'backend_theme_v10_mod_sdtodolores/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/sdtodolores/'\
                    'backend_theme_v10_mod_sdtodolores/static/src/css/'\
                    'backend_mod_new.css'
