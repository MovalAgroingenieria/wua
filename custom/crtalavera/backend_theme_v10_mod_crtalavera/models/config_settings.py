...
class CustomColorConfiguration(models.TransientModel):
    ...
    def init(self):
        ...
        for path in addons_path:
            if '/custom/crtalavera' in path \
                    and self._module == 'backend_theme_v10_mod_crtalavera':
                path = os.path.dirname(path)
                varless_file = path + '/crtalavera/'\
                    'backend_theme_v10_mod_crtalavera/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/crtalavera/'\
                    'backend_theme_v10_mod_crtalavera/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/custom/crtalavera' in path \
                ...
                varless_file = path + '/crtalavera/'\
                    'backend_theme_v10_mod_crtalavera/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/crtalavera/'\
                    'backend_theme_v10_mod_crtalavera/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/crtalavera/'\
                    'backend_theme_v10_mod_crtalavera/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/crtalavera/'\
                    'backend_theme_v10_mod_crtalavera/static/src/css/'\
                    'backend_mod_new.css'
