...
class CustomColorConfiguration(models.TransientModel):
    ...
    def init(self):
        ...
        for path in addons_path:
            if '/wua/custom/cgrabaran' in path \
                    and self._module == 'backend_theme_v10_mod_cgrabaran':
                path = os.path.dirname(path)
                varless_file = path + '/cgrabaran/'\
                    'backend_theme_v10_mod_cgrabaran/static/src/less/'\
                    'variables_mod.less'
                backendcss_file = path + '/cgrabaran/'\
                    'backend_theme_v10_mod_cgrabaran/static/src/css/'\
                    'backend_mod.css'
        ...
        for path in addons_path:
            if '/wua/custom/cgrabaran' in path \
                ...
                varless_file = path + '/cgrabaran/'\
                    'backend_theme_v10_mod_cgrabaran/static/src/less/'\
                    'variables_mod.less'
                varless_file_new = path + '/cgrabaran/'\
                    'backend_theme_v10_mod_cgrabaran/static/src/less/'\
                    'variables_mod_new.less'
                backendcss_file = path + '/cgrabaran/'\
                    'backend_theme_v10_mod_cgrabaran/static/src/css/'\
                    'backend_mod.css'
                backendcss_file_new = path + '/cgrabaran/'\
                    'backend_theme_v10_mod_cgrabaran/static/src/css/'\
                    'backend_mod_new.css'
